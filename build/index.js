...
function DayView({
  ...
  if (!hasOpen) {
    let closedText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Closed', 'telex-hours-block');
...
function HolidayEditor({
  ...
  const currentSlots = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
    const holidaySlots = (0,_utils_slots__WEBPACK_IMPORTED_MODULE_4__.normalizeHolidaySlots)(holiday);
    return holidaySlots.length > 0 ? holidaySlots : [{
      open: '',
      close: ''
    }];
  }, [holiday]);
...
function WeekView({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("dl", {
    ...
    children: orderedDays.filter(({
      ...
      } else if (preview.currentSeason && preview.currentSeason.hours) {
        const dayData = preview.currentSeason.hours[dk];
        if (dayData) {
          daySlots = (0,_utils_slots__WEBPACK_IMPORTED_MODULE_2__.normalizeSlots)(dayData);
        }
      }
...
function Edit({
  ...
  const rawSeasons = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => Array.isArray(seasons) ? seasons : [], [seasons]);
  const rawHolidays = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => Array.isArray(holidays) ? holidays : [], [holidays]);
    ...
    return openSlots.map((slot, si) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
      children: [si > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("br", {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("span", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("time", {
          dateTime: (0,_utils_time__WEBPACK_IMPORTED_MODULE_8__.to24h)(slot.open),
          ...
          dateTime: (0,_utils_time__WEBPACK_IMPORTED_MODULE_8__.to24h)(slot.close),
...
function useSchedulePreview(seasons, holidays) {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    ...
    if (currentHoliday) {
      ...
      if (dayData) {
        slots = (0,_utils_slots__WEBPACK_IMPORTED_MODULE_3__.normalizeSlots)(dayData);
      }
    }
    return {
      currentSeason,
...
/* harmony export */   to24h: () => (/* binding */ to24h)
/* harmony export */ });
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
/**
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunk_carstingaxion_telex_hours_block"] = globalThis["webpackChunk_carstingaxion_telex_hours_block"] || [];
